                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="bonus_type">
                                        @foreach(sendFeesType() as $key_sft=>$value_sft)
                                            <option value="{{$key_sft}}" @if(isset($item) && $item->bonus_type == $key_sft) selected @endif >{{$value_sft}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <select class="form-control" name="bonus_coin_type">
                                        @if(isset($coins[0]))
                                            @foreach($coins as $coin)
                                                <option value="{{$coin->type}}" @if(isset($item) && $item->bonus_coin_type == $coin->type) selected @endif >{{check_default_coin_type($coin->type)}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
